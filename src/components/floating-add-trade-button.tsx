...
export function FloatingAddTradeButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-7 right-7 z-[70] hidden size-[3.75rem] isolate place-items-center overflow-hidden rounded-full border border-emerald-300/40 bg-[radial-gradient(circle_at_30%_22%,rgba(255,255,255,0.28),transparent_28%),linear-gradient(145deg,#2ee673_0%,#19b956_58%,#109342_100%)] text-[#021309] shadow-[0_18px_50px_rgba(34,197,94,0.26),0_6px_18px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.32)] transition duration-200 before:pointer-events-none before:absolute before:inset-1 before:-z-10 before:rounded-[inherit] before:border before:border-white/12 hover:-translate-y-0.5 hover:scale-[1.035] hover:brightness-110 hover:shadow-[0_22px_58px_rgba(34,197,94,0.34),0_8px_22px_rgba(0,0,0,0.56),inset_0_1px_0_rgba(255,255,255,0.36)] active:scale-95 lg:grid [&_svg]:size-[1.7rem] [&_svg]:transition-transform [&_svg]:duration-200 hover:[&_svg]:rotate-90"
    >
