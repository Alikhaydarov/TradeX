...
export function WorkspaceTopbar({ section }: { section: Section }) {
  ...
  return (
    <header
      role="banner"
      className="tw-app-topbar sticky top-0 z-[70] shrink-0 border-b border-white/8 bg-black/95 px-3 py-2.5 backdrop-blur-md lg:flex lg:min-h-16 lg:items-center lg:gap-5 lg:px-6 lg:py-2.5"
    >
      <div className="flex min-w-0 items-center gap-2 lg:flex-1 lg:gap-5">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex min-w-0 items-center gap-2.5">
            <h1 className="truncate text-base font-semibold leading-tight text-white lg:text-[17px]">
              {page}
            </h1>
            {isAccountScoped ? (
