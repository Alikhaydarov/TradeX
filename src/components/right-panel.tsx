...
export function RightPanel() {
  return (
    <aside className="sticky top-0 hidden h-screen w-[350px] shrink-0 px-5 py-2 xl:block">
      <label className="flex h-11 items-center gap-3 rounded-full bg-[#202327] px-4 text-xmuted focus-within:ring-1 focus-within:ring-xblue">
      ...
      <section className="mt-4 rounded-2xl border border-xborder p-4">
