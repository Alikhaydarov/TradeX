...
const WORKSPACE_STRUCTURE_CLASS = [
  ...
  "lg:[&>.workspace-shell>aside:not([data-community-sidebar])]:!w-[238px] lg:[&>.workspace-shell>aside:not([data-community-sidebar])]:!p-[.85rem] lg:[&>.workspace-shell>aside:not([data-community-sidebar])]:!border-r lg:[&>.workspace-shell>aside:not([data-community-sidebar])]:!border-r-white/[.1]",
  "lg:[&>.workspace-shell>aside:not([data-community-sidebar])]:bg-[radial-gradient(circle_at_18%_0%,rgba(52,211,153,.055),transparent_28%),linear-gradient(180deg,#030403_0%,#000_46%,#020302_100%)]",
  "lg:[&>.workspace-shell>aside:not([data-community-sidebar])+div[aria-hidden='true']]:!w-[238px]",
